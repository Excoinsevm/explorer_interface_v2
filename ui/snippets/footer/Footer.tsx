  ...
  const BLOCKSCOUT_LINKS = [
    {
      ...
      iconSize: '18px',
      text: 'Github',
      url: 'https://github.com/bitrockchain',
    },
    {
      icon: twitterIcon,
      iconSize: '18px',
      text: 'Twitter',
      url: 'https://www.twitter.com/bitrockchain',
    },
    {
      icon: discordIcon,
      iconSize: '18px',
      text: 'Discord',
      url: 'https://discord.com/invite/xUTRESq8Xq',
    },
    {
      icon: discussionsIcon,
      iconSize: '20px',
      text: 'Discussions',
      url: 'https://bitrockchain.medium.com/',
    },
  ];
    ...
    >
      <Box flexGrow="1" mb={{ base: 8, lg: 0 }}>
        ...
        <VStack spacing={ 1 } mt={ 6 } alignItems="start">
          { apiVersionUrl && (
            <Text fontSize="xs">
                Bitrock Explorer: <Link href="#">Version 2.1.1</Link>
            </Text>
          ) }
          {/* { frontendLink && (
            <Text fontSize="xs">
